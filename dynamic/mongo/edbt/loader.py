...
class MongoEdbtLoader(MongoLoader):
    ...
    def _get_constraints(self):
        return [
            ...
            MongoIndex('person', ['country_code', 'is_active']),
            MongoIndex('person', ['is_active']),
            MongoIndex('person', ['interests.category.category_id']),
            MongoIndex('person', ['interests.category.category_id', 'is_active']),
            MongoIndex('person', ['follows.to_person.person_id']),

            MongoIndex('customer', ['customer_id'], is_unique=True),
            MongoIndex('customer', ['person_id']),
            MongoIndex('customer', ['country_code', 'is_active', 'snapshot_at']),
            MongoIndex('customer', ['snapshot_at']),

            MongoIndex('seller', ['seller_id'], is_unique=True),
            MongoIndex('seller', ['country_code']),
            MongoIndex('seller', ['country_code', 'is_active']),
            ...
            MongoIndex('product', ['seller.seller_id', 'price_cents']),
            MongoIndex('product', ['seller.country_code']),
            MongoIndex('product', ['categories.category.category_id']),
            MongoIndex('product', ['categories.category.category_id', 'is_active']),
            MongoIndex('product', ['categories.category.path']),
            MongoIndex('product', ['price_cents']),
            MongoIndex('product', ['stock_qty']),
            ...
            MongoIndex('order', ['status', 'ordered_at']),
            MongoIndex('order', ['customer.customer_id']),
            MongoIndex('order', ['customer.person_id']),
            MongoIndex('order', ['customer.person_id', 'ordered_at']),
            MongoIndex('order', ['customer.person_id', 'status', 'ordered_at']),
            MongoIndex('order', ['shipping.country', 'status', 'ordered_at']),
            MongoIndex('order', ['currency', 'payment.method', 'shipping.method', 'total_cents']),
            MongoIndex('order', ['items.product.product_id']),
            MongoIndex('order', ['items.product.product_id', 'ordered_at']),
            MongoIndex('order', ['items.product.seller_id', 'ordered_at']),
            ...
            MongoIndex('review', ['product_id', 'created_at']),
            MongoIndex('review', ['customer_id']),
            MongoIndex('review', ['customer_id', 'created_at']),
            MongoIndex('review', ['created_at']),
            MongoIndex('review', ['created_at', 'rating', 'helpful_votes']),
        ]
