...
def export():
    return PostgresTpchQueryRegistry()

class PostgresTpchQueryRegistry(TpchQueryRegistry[str]):

    def __init__(self):
        super().__init__(DriverType.POSTGRES)

    @query('basic-0', 'TPC-H Query 1 variations')
    ...
    @query('basic-1', 'TPC-H Query 3 variations')
    def _orders(self):
    ...
    @query('basic-2', 'TPC-H Query 5 variations')
    ...
    @query('basic-3', 'TPC-H Query 6 variations')
    ...
    @query('basic-4', 'TPC-H Query 10 variations')
    ...
    @query('basic-5', 'TPC-H Query 12 variations')
    ...
    @query('join-1', 'Parts and Suppliers')
    ...
    @query('join-4', 'Customer Nation Analysis')
    ...
    @query('join-5', 'Part Lineitem Summary')
    ...
    @query('subquery-0', 'High Value Customers')
    ...
    @query('subquery-1', 'Frequent Buyers')
    ...
    @query('subquery-2', 'Popular Parts')
    ...
    @query('subquery-3', 'Top Suppliers by Volume')
    ...
    @query('subquery-4', 'Orders Above Average')
    ...
    @query('subquery-5', 'Customers with Recent Large Orders')
    ...
    @query('large-scan-0', 'Lineitems by Price')
    ...
    @query('large-scan-1', 'Orders by Date')
    ...
    @query('large-scan-2', 'Parts by Price')
    ...
    @query('large-scan-3', 'Customer Balance Ranking')
    ...
    @query('large-scan-4', 'Lineitem Quantity Sort')
    ...
    @query('large-scan-5', 'Recent Shipments')
