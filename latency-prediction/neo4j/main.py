...
def save_workload_data(queries: List[str], plans: List[Dict], 
...
def main():
    ...
    parser.add_argument('--num-queries', type=int, default=250,
                       help='Number of query variants to generate')
    ...
    parser.add_argument('--num-layers', type=int, default=5,
                       help='Number of layers per neural unit')
    parser.add_argument('--data-vec-dim', type=int, default=32,
                       help='Data vector dimension')
    parser.add_argument('--val-split', type=float, default=0.2,
                       help='Validation split ratio')
    parser.add_argument('--load-workload', type=str, default=None,
                       help='Path to load previously collected workload data')
    parser.add_argument('--save-workload', type=str, default='data/neo4j_workload_data.pkl',
                       help='Path to save collected workload data')
    parser.add_argument('--checkpoint-path', type=str, default='data/neo4j_qpp_checkpoint.pt',
