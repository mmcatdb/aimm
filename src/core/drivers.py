...
class DriverType(Enum):
    """Identifies a specific database application.

    Don't use any other values like `Postgres`, `PostgreSQL`, or sth.
...
# Not used right now. Might be useful one day.
DriverId = str
"""Identifies a database application with version.

Pattern: {driver_type}-{version}. Version uses only numbers and dots.
Example: `postgres-18.2`, `mongo-8.0.3`, `neo4j-2026.01.4`.
"""
