...
class EdbtMongoDatabase(EdbtDatabase[MongoQuery]):
    ...
    def __init__(self):
        ...
        raise NotImplementedError('MongoDB implementation is not ready yet. This is a placeholder to show where Mongo-specific queries would go.')
    ...
    def _top_products_by_revenue(self):
        # $lookup from order.order_item.product to product
        pass
        # return f'''
    ...
    def _who_to_follow(self):
        # $lookup from person.follows.person to person
        pass
    ...
    def _personalized_feed_candidates(self):
        # $lookup from person.category to product.category
        pass
        # return f'''
