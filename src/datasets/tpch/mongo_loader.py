...
class TpchMongoLoader(MongoLoader):
    ...
    def _get_schemas(self):
        ...
        # TODO this
        # Preview of some embedded structures - expand this
        ...
        # Simple non-nested documents for now - we can fix this later.
    ...
    def _get_indexes(self):
        return [
            ...
            # IndexSchema('order', [ 'key' ], is_unique=True),
