...
class TpchNeo4jDAO(Neo4jDAO, TpchDAO):
    ...
    def get_all_lineitems(self):
        ...
        return self.execute('MATCH (l:lineitem) RETURN l LIMIT 200000')
    ...
    def get_orders_by_daterange(self, start_date, end_date):
        ...
        return self.execute(query, {'start_date': start_date, 'end_date': end_date})

    @override
    def get_all_customers(self):
        return self.execute('MATCH (c:customer) RETURN c')
    ...
    def get_orders_by_keyrange(self, start_key, end_key):
        ...
        return self.execute(query, {'start_key': start_key, 'end_key': end_key})
    ...
    def get_all_parts(self):
        return self.execute('MATCH (p:part) RETURN p')
    ...
    def get_lowest_cost_supplier_for_part(self, partkey):
        ...
        """
        res = self.execute(query, {'pk': str(partkey)})
